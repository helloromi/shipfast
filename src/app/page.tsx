...
export const metadata: Metadata = {
  ...
  openGraph: buildOpenGraph({ title: TITLE, description: DESCRIPTION, url: "/" }),
...
/**
 * Page d'accueil. Elle vivait sur /landing, et `/` se contentait d'y rediriger en 307 :
 * l'URL racine — celle qui reçoit les liens, les recherches de marque et l'autorité du
 * domaine — ne servait donc aucun contenu, et la chaîne complète depuis le domaine nu
 * faisait deux sauts temporaires (point B5 de l'audit du 30/07/2026).
 *
 * Le rendu reste dynamique, comme il l'était déjà ici : la page lit la session pour
 * envoyer un utilisateur connecté sur son tableau de bord. Cette redirection-là garde
 * volontairement un 307 — elle dépend de la session, et un 308 se ferait mettre en
 * cache par le navigateur, collant un visiteur fraîchement connecté sur l'accueil.
 */
