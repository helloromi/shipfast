        ...
        <div className="relative flex items-center gap-3">
          {session?.user ? (
            <>
              ...
              {mobileMenuOpen && (
                <div className="absolute right-0 top-12 z-30 w-56 rounded-2xl border border-[#e7e1d9] bg-white/95 shadow-lg sm:hidden">
                ...
                {menuOpen && (
                  <div className="absolute right-0 top-12 z-20 w-56 rounded-2xl border border-[#e7e1d9] bg-white/95 shadow-lg">
                    ...
                    <Link
                      ...
                      className="flex w-full items-center justify-between px-4 py-3 text-sm font-semibold text-[#3b1f4a] transition hover:bg-[#f4c95d33]"
                    >
                      <span>{t.common.header.monCompte}</span>
                    </Link>
                    <button
