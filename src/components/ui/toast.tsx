...
export function Toast({ message, variant = "success", onClose, duration = 3500 }: ToastProps) {
  ...
  const base =
    "fixed top-4 left-4 right-4 sm:left-auto sm:right-4 z-[200] flex w-[calc(100vw-2rem)] sm:w-auto sm:max-w-sm items-start gap-3 rounded-2xl border px-4 py-3 text-sm shadow-lg shadow-[#3b1f4a1a] backdrop-blur-md";
  const styles =
    variant === "success"
