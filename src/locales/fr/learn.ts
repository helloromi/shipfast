export const learn = {
  ...
  setup: {
    ...
    previewIntro: "Relis le passage en entier. Tes répliques sont surlignées.",
    previewRoleBadge: "ton rôle",
    previewBack: "Retour",
  ...
  messages: {
    ...
    ctaCompteAnonyme: "Créer un compte pour sauvegarder ta progression",
