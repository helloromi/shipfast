export const scenes = {
  ...
  works: {
    ...
    access: {
      ...
      description: "Abonnez-vous à 5€/mois pour débloquer l’apprentissage, l’import et toute la bibliothèque.",
      freeSlotAvailable: "—",
      freeSlotInfo: "—",
      useFreeSlot: "—",
      granting: "—",
      purchaseRequired: "Un abonnement est requis pour accéder à ce contenu.",
      purchaseButton: "S’abonner — 5€/mois",
    },
    privateScenes: {
